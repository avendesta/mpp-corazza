...
//	}
	...
	List<String> processList(List<String> list)  {
	    ...
	    return list.stream()
	    		   .map(x -> doNothingIfShortHelper(x)) // This will NOT fail to compile 
	               .collect(Collectors.toList());
	...
	public static String doNothingIfShortHelper(String input) {
		try {
			return new FixThis().doNothingIfShort(input);
