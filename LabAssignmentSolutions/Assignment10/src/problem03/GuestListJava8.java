...
public class GuestListJava8 {
	...
	private boolean checkLegalHelper(Guest g) throws RuntimeException {
		try {
			return checkLegal(g);
	...
	public void printListOfExpectedFemaleGuests(List<Guest> invited) {
		//implement
		String femaleGuestsComing = 
			invited.stream()
				.filter(g -> checkLegalHelper(g))
		...
		System.out.println(femaleGuestsComing);
	}
