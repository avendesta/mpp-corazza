...
import lesson5.labs.prob3.control.Control;
...
public class Start extends JFrame {
	...
	private void defineMiddlePanel(){
		...
		logout.addActionListener(evt -> messageBar.setText("LoggedOut Successful!"));
		...
		gradeReport.addActionListener(evt -> messageBar.setText("Not logged!"));
		teacherRmks.addActionListener(Control.INSTANCE.getRemarksListener());
		teacherRmks.addActionListener(evt -> messageBar.setText("Not logged!"));
		upper.add(login);
		upper.add(logout);
