...
public class MainFrame extends JFrame {
	...
	ListItem item2 = new ListItem("ViewTitles", true);
	ListItem item3 = new ListItem("AddBook", true);
...
//	}
	...
	public MainFrame() {
		...
		linkList.addListSelectionListener(event -> {
			...
			Data.addBookTitle("One");
			System.out.println(Data.bookTitles);
		...
		innerPane.setDividerLocation(120);
	...
	public void createTextBar() {
		textBar = new JPanel();
		textBar.setLayout(new BorderLayout());
		JTextArea infoArea = new JTextArea("Welcome");
		textBar.add(infoArea);
	}
...
//		JPanel panel3 = p3.getMainPanel();
		...
		cards.add(LoginPanel.INSTANCE.init(), "Login");
		cards.add(ViewTitlesPanel.INSTANCE.init(), "ViewTitles");
		cards.add(new AddBookPanel(), "AddBook");
...
//		JPanel mainPanel = new LoginPanel();
