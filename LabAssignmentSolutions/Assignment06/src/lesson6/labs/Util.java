...
public class Util {
	...
	public static void Serialize(String ob) throws IOException {
	      try {
	          FileOutputStream fileOut =
	          new FileOutputStream("C:\\Users\\tooet\\Music\\Strings.ser");
	          ObjectOutputStream out = new ObjectOutputStream(fileOut);
	          out.writeObject(ob);
	          out.close();
	          fileOut.close();
	          System.out.printf("C:\\Users\\tooet\\Music\\Strings.ser");
	       } catch (IOException i) {
	          i.printStackTrace();
	       }
	}
	public static String Deserialize() {
	      String e = null;
	      try {
	         FileInputStream fileIn = new FileInputStream("C:\\Users\\tooet\\Music\\Strings.ser");
